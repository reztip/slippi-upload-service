package com.rez.melee.slippi.config;
...
@Configuration
@EnableMongoRepositories("com.rez.melee.slippi.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.rez.melee.slippi.config.dbmigrations");
